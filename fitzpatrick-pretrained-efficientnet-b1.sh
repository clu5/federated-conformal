...
# Centrally hosted
python src/run_TCT.py --dataset fitzpatrick --architecture efficientnet-b1 --central --rounds_stage1 200 --rounds_stage2 0 --local_epochs_stage1 1 --local_lr_stage1 0.001 --momentum 0.9 --batch_size 64 --use_data_augmentation --save_dir experiments --data_dir ../data --pretrained
